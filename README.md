...
**Active priority:** [MS-HAB this week](docs/mshab-reproduction-priority.md); LIBERO is a bounded author-component check, not a full-reproduction prerequisite. New AC-DiT head development is deferred; prioritize the author-architecture π₀.₅ port.

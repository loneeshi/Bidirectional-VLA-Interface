...
| C | Official PPO | Fetch-adapted pi0.5 | [Actual state-conditioned control, Pick failed](media/C-pi05-state-failed.mp4); velocity-input pilot also failed; recovery-data training underway | Individual Pick/Place and composed success |

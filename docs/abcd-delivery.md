...
| C | Official PPO | Fetch-adapted pi0.5 | [Actual state-conditioned control, Pick failed](media/C-pi05-recovery-failed.mp4); velocity/recovery pilots also failed; relative-base training underway | Individual Pick/Place and composed success |

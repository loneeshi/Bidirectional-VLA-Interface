...
本批只做探索性离线选择。候选的 SAC 结果来自各自独立重建的原交接状态；C0 力超限或时限耗尽后，不能在同一 episode 内把那些结果当作在线恢复成功。[第一实验记录](../../../docs/log/2026-09-23-c2-sac-pose-capability.md)保留原样。
...
候选图像见[已冻结的 A3 图像](../../../docs/media/README.md)；A3 的旧回答不作为本次 B0。

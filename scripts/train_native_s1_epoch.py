"""One bounded S1 epoch, explicit held-out validation and best/latest recovery.
...
def main():
    ...
    cfg=dataclasses.replace(cfg,exp_name='medium-one-epoch',seed=7)
    ...
    report=dict(status='initializing',stage='S1',updates=0,total_updates=total,api_calls=0,
